...
def generate_markdown_ipynbtutorial(tutorial_path='../examples/tutorial/') : 
    """Generate Markdown files from all ipynb notebook in the tutorial 
    Parameters 
    ---------- 
    tutorial_path : str, default '../examples/tutorial/'
        path to the tutorial directory
    """ 
    run('jupyter nbconvert --to markdown '+tutorial_path+'*.ipynb', shell = True)
    run('mv '+tutorial_path+'*.md ../docs/', shell = True)


if __name__ == "__main__" : 
    generate_parameters_md()
    generate_markdown_ipynbtutorial()

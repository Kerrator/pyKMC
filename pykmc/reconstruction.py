...
import numpy as np
import copy
from pykmc.utils.geometry import push_towards, compute_delr_max
import ase.geometry
...
class Reconstruction:
    ...
    def reconstruct(
        ...
        if delr1 > self.config.psr.matching_score_thr:
            ...
            # delr2 = compute_delr_max(supposed_min2_positions, min2_pos[neighbors], cell)
            delr2 = compute_delr_max(supposed_min2_positions, t2[neighbors], cell)

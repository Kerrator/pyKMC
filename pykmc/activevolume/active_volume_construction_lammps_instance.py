...
class ActiveVolume:
    ...
    def __init__(self, system: System, lmp: lammps, config : Config) -> None:
    ...
    def make_active_volume(self) -> None:
        ...
        initialize_system(engine, self.av) #This encompasses making the av system
        initialize_potential(engine, self.av)
        ...
        self.lmp_positions = get_positions(engine)

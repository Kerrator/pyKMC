...
class Manager:
    ...
    def initialize_sessions(self, config, system) :
        ...
        # desynced pool fails fast instead of stalling (HANDOFF_recycle_pool_hang.md).
    ...
    def close_all(self):
        ...
        when the recycle "All event reconstructions failed" path closes the pool in
        global mode (see HANDOFF_close_all_teardown_hang.md).
